// --------------------------------------------------------------------
// WARNING DO NOT OVERWRITE BLINDLY - SOME ADJUSTMENTS HAVE BEEN MADE
// --------------------------------------------------------------------
/*
...
#include "core/filesystem/physfs/physfsrwops.h"
...
#endif
{
    ...
    else if (whence == RW_SEEK_CUR)
    {
        ...
        if (current == -1)
        {
            ...
            SDL_SetError("Can't find position in file: %s", error);
            return -1;
        } /* if */
    ...
    else if (whence == RW_SEEK_END)
    {
        ...
        if (len == -1)
        {
            ...
            SDL_SetError("Can't find end of file: %s", error);
            return -1;
        } /* if */
    ...
    if (!PHYSFS_seek(handle, (PHYSFS_uint64) pos))
    {
        ...
        SDL_SetError("PhysicsFS error: %s", error);
        return -1;
    } /* if */
